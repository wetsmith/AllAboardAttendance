# Generated by Django 2.2.1 on 2019-07-22 00:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 22, 0, 46, 29, 17132, tzinfo=utc), verbose_name='date published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture_graph', models.ImageField(blank=True, default='graphs/default.png', storage=lecture.storage.OverwriteStorage(), upload_to='graphs')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 22, 0, 46, 28, 989178, tzinfo=utc), verbose_name='date published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 22, 0, 46, 29, 18177, tzinfo=utc), verbose_name='date connection made')),
