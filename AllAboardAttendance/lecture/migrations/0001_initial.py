# Generated by Django 2.2.1 on 2019-07-08 22:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 8, 22, 2, 42, 914446, tzinfo=utc), verbose_name='date published')),
            ],
        ),
        migrations.CreateModel(
            name='Lecture',
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 8, 22, 2, 42, 839767, tzinfo=utc), verbose_name='date published')),
            ],
        ),
        migrations.CreateModel(
            name='DirEdge',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 8, 22, 2, 42, 914446, tzinfo=utc), verbose_name='date connection made')),
