# Generated by Django 2.2.2 on 2019-07-14 21:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 14, 21, 54, 21, 883600, tzinfo=utc), verbose_name='date published')),
            ],
        ),
        migrations.CreateModel(
            name='Lecture',
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 14, 21, 54, 21, 764432, tzinfo=utc), verbose_name='date published')),
            ],
        ),
        migrations.CreateModel(
            name='DirEdge',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 14, 21, 54, 21, 884307, tzinfo=utc), verbose_name='date connection made')),
