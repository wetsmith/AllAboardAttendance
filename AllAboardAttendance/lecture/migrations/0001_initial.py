    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 19, 20, 11, 38, 275054, tzinfo=utc), verbose_name='date published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 19, 20, 11, 38, 223587, tzinfo=utc), verbose_name='date published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 19, 20, 11, 38, 275556, tzinfo=utc), verbose_name='date connection made')),
