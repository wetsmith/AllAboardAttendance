    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 21, 21, 19, 41, 578938, tzinfo=utc), verbose_name='date published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture_graph', models.ImageField(null=True, upload_to='graphs')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 21, 21, 19, 41, 520438, tzinfo=utc), verbose_name='date published')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(default=datetime.datetime(2019, 7, 21, 21, 19, 41, 579514, tzinfo=utc), verbose_name='date connection made')),
